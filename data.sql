...
INSERT INTO vets (name, age, date_of_graduation) VALUES ('Stephanie Mendez', 64, '2019-05-17');

INSERT INTO vets (name, age, date_of_graduation) VALUES ('Jack Harknes', 38, '2008-06-08');
...
INSERT INTO visits (animal_id, vet_id, vist_date) 
VALUES ((SELECT id FROM animal WHERE name = 'Agumon'), (SELECT id FROM vets WHERE name = 'William Tatcher'), '2020-05-24');
